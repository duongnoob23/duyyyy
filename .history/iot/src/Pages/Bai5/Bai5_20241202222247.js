...
function Bai5(){    
    ...
    const handleTurnOnCloud = () => {
        setTurnOn3(!turnOn3);
        fetchPostApi(turnOn3,"cloud","data/light4");
    }

    const handleTurnOnThunder = () => {
        setTurnOn4(!turnOn4);
        fetchPostApi(turnOn4,"thunder","data/light5");
    }
     return(
        //
        <>
                    ...
                    <div className="control">
                        <ul className="control-list ">
                            <li className="control-item">
                                ...
                                <i className={turnOn3 ? "fa-solid fa-cloud control-cloud show" : "fa-solid fa-cloud control-cloud"}></i>
                            ...
                            <li className="control-item">
                                ...
                                <i className={turnOn4 ? "fa-solid fa-bolt control-thunder show" : "fa-solid fa-bolt control-thunder"}></i>

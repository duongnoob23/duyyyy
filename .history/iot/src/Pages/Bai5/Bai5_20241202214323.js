                    ...
                    <div className="control">
                        <ul className="control-list ">
                            <li className="control-item">
                                ...
                                <label htmlFor="control-input1" className="control-label" onClick={handleTurnOnLight}></label>
                                    </div>
                                    
                                
                                <div className="on-off">{turnOn3 ? "On" : "Off"}</div>
                                <i className={turnOn3 ? "fa-regular fa-lightbulb control-light show" : "fa-regular fa-lightbulb control-light"}></i>
                            ...
                            <li className="control-item">
                                ...
                                <i className={turnOn4 ? "fa-regular fa-lightbulb control-light show" : "fa-regular fa-lightbulb control-light"}></i>
                                <div className="light">Lights</div>
                            </li>      
                        </ul>
                    </div>

                    ...
                    <div className="control">
                        <ul className="control-list ">
                            <li className="electric-item">
                                ...
                                <input checked={turnOn3} type="checkbox" className="electric-input" id="electric-input1" />
                                ...
                                <i className={turnOn3 ? "fa-regular fa-lightbulb electric-light show" : "fa-regular fa-lightbulb electric-light"}></i>
                                <div className="light">Lights</div>
                            </li>  
                            <li className="electric-item">
                                <div className="electric-box">
                                <input checked={turnOn4} type="checkbox" className="electric-input" id="electric-input1" />
                                <label htmlFor="electric-input1" className="electric-label" onClick={handleTurnOnLight}></label>
                                    </div>
                                    
                                
                                <div className="on-off">{turnOn4 ? "On" : "Off"}</div>
                                <i className={turnOn4 ? "fa-regular fa-lightbulb electric-light show" : "fa-regular fa-lightbulb electric-light"}></i>
                                <div className="light">Lights</div>
                            </li>      
                        </ul>
                    </div>
